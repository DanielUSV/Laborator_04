...
namespace Main
{
    ...
    internal class Window3D : GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e) {
            ...
            //Schimba culoarea fetei din stanga
            if (keyboard[Key.C] && !keyboard.Equals(lastKeyPress))
            {
                randomColor = Color.FromArgb(r.Next(256), r.Next(256), r.Next(256));
                colorVertices[10] = randomColor;
                colorVertices[11] = randomColor;
            }

            //Modificare culoarea fiecare triunghi + afisare valori RGB in consola 
